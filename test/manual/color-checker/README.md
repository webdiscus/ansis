...
Run it in different terminals, shells, process managers, and runtimes
to inspect the environment values used by ansis color detection
and visually check whether ANSI colors render correctly.
